    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加关于信息</h4></div>
              <div class="card-body">
                <form action="add" id="menu-add-form" method="post" class="row">
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">标题</span>
                    <input type="text" class="form-control required" id="caption" name="caption" value="" placeholder="请输入标题"
                           tips="请输入标题" />
                  </div>
                    <div class="input-group m-b-10">
                        <span class="input-group-addon">内容</span>
                        <textarea style="height:250px" id="content" name="content" placeholder="请输入内容"></textarea>
                    </div>
