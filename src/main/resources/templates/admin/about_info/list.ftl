...
<title>${siteName!""}|关于管理-${title!""}</title>
              ...
              <div class="card-toolbar clearfix">
                <form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="${caption!""}" name="caption" placeholder="请输入标题">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as about>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${about.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">${about.caption}</td>
                        <td style="vertical-align:middle;">${about.content}</td>
                        <td style="vertical-align:middle;">${about.createTime}</td>
                      </tr>
                    </#list>
                    <#else>
