...
<title>${siteName!""}|新闻管理-${titles!""}</title>
            ...
            <div class="card">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="titles">新闻标题</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${title!""}" name="title" placeholder="请输入新闻标题">
              ...
              <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">${news.label.name}</td>
                        <td style="vertical-align:middle;">
                        	<#if news.pic??>
                        		<#if news.pic?length gt 0>
                        		<img src="/photo/view?filename=${news.pic}" width="60px" height="60px">
                        		<#else>
                        ...
                        <td style="vertical-align:middle;">${news.user.username}</td>
                ...
                <ul class="pagination ">
                  ...
                  <#else>
                  <li><a href="list?titles=${titles!""}&currentPage=1">«</a></li>
                  </#if>
                  <#list pageBean.currentShowPage as showPage>
                  <#if pageBean.currentPage == showPage>
                  <li class="active"><span>${showPage}</span></li>
                  <#else>
                  <li><a href="list?titles=${titles!""}&currentPage=${showPage}">${showPage}</a></li>
                  </#if>
                  </#list>
                  <#if pageBean.currentPage == pageBean.totalPage>
                  <li class="disabled"><span>»</span></li>
                  <#else>
                  <li><a href="list?titles=${titles!""}&currentPage=${pageBean.totalPage}">»</a></li>
                  </#if>
