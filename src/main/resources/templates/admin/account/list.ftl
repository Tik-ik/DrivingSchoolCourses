            ...
            <div class="container-fluid">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <button class="btn btn-default dropdown-toggle" id="search-btn"
                                                    ...
                                                    aria-expanded="false">
                                                前台用户名 <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="title">前台用户名</a></li>
                                            </ul>
                                        </div>
                ...
                <#include "../common/third-menu.ftl"/>
                      ...
                      <tr>
                          ...
                          <td style="vertical-align:middle;">${account.password}</td>
                          <#if account.getStatus() == 0>
                              <td style="vertical-align:middle;">不可用</td>
                          <#else>
                              <td style="vertical-align:middle;">可用</td>
                          </#if>
                          <td style="vertical-align:middle;">
                        	<#if account.headPic??>
                            ...
                            <#if pageBean.total gt 0>
                                <ul class="pagination ">
                                    ...
                                    <#list pageBean.currentShowPage as showPage>
                                        ...
                                        <#else>
                                            <li><a href="list?username=${username!""}&currentPage=${showPage}">${showPage}</a>
                                            </li>
                                        </#if>
                                    </#list>
