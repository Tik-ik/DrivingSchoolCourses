...
<title>${siteName!""}|教练管理-${title!""}</title>
                ...
                <form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      教练名 <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">教练名</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${name!""}" name="name" placeholder="请输入教练名">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle; width: 60px; height: 60px;">
                            <#if coach.headPic??>
                                <#if coach.headPic?length gt 0>
                                    <img src="/photo/view?filename=${coach.headPic}" width="60px" height="60px">
                                <#else>
                        ...
                        <td style="vertical-align:middle;">${coach.phone}</td>
                        <td style="vertical-align:middle;">${coach.email}</td>
                        <td style="vertical-align:middle;">${coach.coachType.name}</td>
                        <td style="vertical-align:middle;">${coach.introduce}</td>
                        <td style="vertical-align:middle;">${coach.signature}</td>
                      </tr>
                    </#list>
                    <#else>
