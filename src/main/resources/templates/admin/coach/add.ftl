    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加教练</h4></div>
              <div class="card-body">
                <form action="add" id="menu-add-form" method="post" class="row">
                    <div class="form-group col-md-12">
                      ...
                      <div class="input-group m-b-10">
                        ...
                        <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请输入教练名"
                               tips="请输入教练名" />
                      </div>
                    <div class="input-group m-b-10">
                        <span class="input-group-addon">个性签名</span>
                        <input type="text" class="form-control required" id="signature" name="signature"
                               value="" placeholder="请输入个性签名" tips="请输入个性签名" />
                    </div>
                    <div class="input-group m-b-10">
                        <span class="input-group-addon">手机号</span>
                        <input type="text" class="form-control required" id="phone" name="phone"
                               value="" placeholder="请输入手机号" tips="请输入手机号" />
                    </div>
                    <div class="input-group m-b-10">
                        <span class="input-group-addon">邮箱</span>
                        <input type="text" class="form-control required" id="email" name="email"
                               value="" placeholder="请输入邮箱" tips="请输入邮箱" />
                    </div>
                    <div class="input-group m-b-10">
                    ...
                    <div class="input-group m-b-10">
                        ...
                        <textarea class="form-control" id="introduce" name="introduce" rows="5" placeholder="请输入个人简介"></textarea>
                    </div>
                  <div class="form-group col-md-12">
