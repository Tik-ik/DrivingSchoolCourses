...
import com.base.dao.admin.DatabaseBakDao;
import com.base.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	public void backup(){
		...
		try {
			...
			String cmd = "cmd /c C:/asoft/DrivingSchoolCourses/mysqldump -u"+dbUsername+" -p"+dbPwd+" "+dbName+">" + backUpDir + filename;
	...
	public void restore(Long id){
		...
		if(databaseBak != null){
			try {
				...
				String cmd = "cmd /c C:/asoft/DrivingSchoolCourses/mysql -u"+dbUsername+" -p"+dbPwd+" "+dbName+"<" + backUpDir + filename;;
				Runtime.getRuntime().exec(cmd);
				log.info("数据库还原成功");
